const VERSION='marvel-tracker-v8';
const ASSETS=['./','./index.html','./data.json','./manifest.json','./library.json','./x-men.json','./avengers.json','./fantastic-four.json','./daredevil.json'];
